...
HRESULT CBrownWood::Ready_GameObject()
{	
...
int CBrownWood::Update_GameObject()
{
...
void CBrownWood::Late_Update_GameObject()
{
	FrameMove(m_fFrameSpeed);
}

void CBrownWood::Render_GameObject()
{
...
void CBrownWood::Release_GameObject()
{
}

void CBrownWood::Set_Damage(int _InDamage)
{
	 m_tStat.fCurHP -= _InDamage; 
}

void CBrownWood::Change_State()
{
	if (m_ePreState != m_eCurState)
	{
		switch (m_eCurState)
		{
		case CBrownWood::IDLE:
			m_pStateKey = L"BRWON_IDLE";
			m_tFrame.fStartFrame = 0.f;
			m_tFrame.fEndFrame = 5.f;
			m_fFrameSpeed = 1.f;
			break;
		case CBrownWood::WALK:
			m_pStateKey = L"BRWON_WALK";
			m_tFrame.fStartFrame = 0.f;
			m_tFrame.fEndFrame = 6.f;
			m_fFrameSpeed = 1.f;
			break;
		case CBrownWood::ATTACK:
			m_pStateKey = L"BRWON_ATTACK";
			m_tFrame.fStartFrame = 0.f;
			m_tFrame.fEndFrame = 4.f;
			m_fFrameSpeed = 1.f;
			break;
		case CBrownWood::HIT:
			m_pStateKey = L"BRWON_HIT";
			m_tFrame.fStartFrame = 0.f;
			m_tFrame.fEndFrame = 1.f;
			m_fFrameSpeed = 1.f;
			break;
		case CBrownWood::HIT2:
			m_pStateKey = L"BRWON_HIT2";
			m_tFrame.fStartFrame = 0.f;
			m_tFrame.fEndFrame = 1.f;
			m_fFrameSpeed = 1.f;
			break;
		case CBrownWood::DEAD:
			break;
		}
...
void CBrownWood::Check_LeftRight()
{
	if (!m_bAnimisPlaying)
	{
...
void CBrownWood::Monster_Pattern()
{
	switch (m_eCurState)
	{
	case CBrownWood::IDLE:
...
void CBrownWood::ATTACK_STATE()
{
	m_fSpeed = 0.f;

	m_bAnimisPlaying = true;
	if (m_tFrame.fStartFrame >= m_tFrame.fEndFrame * 0.5f && !m_bCreateCol)
	{
		if (!m_bCreateCol)
		{
			if (m_bLeftRight)
...
void CBrownWood::HIT_ILSEOM_STATE()
{
...
void CBrownWood::HIT_BROAD_SWORD()
{
