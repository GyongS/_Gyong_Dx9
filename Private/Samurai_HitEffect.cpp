...
CSamurai_HitEffect::CSamurai_HitEffect()
{
}
...
HRESULT CSamurai_HitEffect::Ready_GameObject()
{
	m_tInfo.vSize = { 1.f, 1.f, 0.f };
	m_pObjectKey = L"HIT_EFFECT";
	m_pStateKey = L"HIT_SAMURAIMODE";
	m_tFrame.fStartFrame = 0.f;
	m_tFrame.fEndFrame = 11.f;
	return S_OK;
}

HRESULT CSamurai_HitEffect::Late_Ready_GameObject()
{
	m_bLeftRight = CGameObject_Manager::Get_Instance()->Get_Player()->Get_bLeftRight();
	return S_OK;
}

int CSamurai_HitEffect::Update_GameObject()
{
...
void CSamurai_HitEffect::Late_Update_GameObject()
{
	FrameMove();
}
void CSamurai_HitEffect::Render_GameObject()
{
...
void CSamurai_HitEffect::Release_GameObject()
{
}
