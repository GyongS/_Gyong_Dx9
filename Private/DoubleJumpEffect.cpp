...
HRESULT CDoubleJumpEffect::Ready_GameObject()
{
	m_tInfo.vSize = { 1.f, 1.f, 0.f };
	m_pObjectKey = L"EFFECT";
	m_pStateKey = L"Double_Jump";
	m_tFrame.fStartFrame = 0.f;
	m_tFrame.fEndFrame = 10.f;
	m_eOBJID = OBJ_ID::EFFECT;
	return S_OK;
}

int CDoubleJumpEffect::Update_GameObject()
{
...
void CDoubleJumpEffect::Late_Update_GameObject()
{
	FrameMove(2.f);
}

void CDoubleJumpEffect::Render_GameObject()
{
...
void CDoubleJumpEffect::Release_GameObject()
{
